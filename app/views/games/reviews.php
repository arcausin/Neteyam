<?php $title = "Tests - " . $game['title'] . " - " . ucfirst($host); ?>

<?php $description = "Retrouvez tous les tests du jeu " . $game['title'] . " référencés sur " . ucfirst($host); ?>

<?php $image = $urlNative . "/public/img/games/" . $game['illustration']; ?>

<?php ob_start(); ?>
<div class="mt-3">
    <p class="mb-3"><a class="text-white animate-opacity" href="/">Acceuil</a> > <a class="text-white animate-opacity" href="/jeux/">Jeux</a> > <a class="text-white animate-opacity" href="/jeux/<?= $game['id_public']; ?>"><?= $game['title']; ?></a> > Tests</p>

    <h1 class="text-center text-md-start fs-2 mb-3">Tests - <?= $game['title']; ?></h1>
    ...
    <div class="text-center text-md-start mb-3">
        ...
        <?php if ($numberReviewsByGame != 0) : ?>
            <a href="/jeux/<?= $game['id_public']; ?>/tests"><span class="badge text-bg-success py-2 fs-6 animate-opacity">Tests</span></a>
        <?php endif ?>
        ...
        <div class="col-12 col-md-6 col-lg-4 mb-3">
            <div class="shadow rounded">
                <a class="text-decoration-none text-white animate-opacity" href="/tests/<?= $review['id_public']; ?>">
                    ...
                    <div class="p-2">
                        <h3 class="fs-6 mb-3"><?= $review['title']; ?></h3>
                    </div>
                </a>
            </div>
        </div>

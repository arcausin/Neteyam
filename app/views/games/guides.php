<?php $title = "Guides - " . $game['title'] . " - " . ucfirst($host); ?>

<?php $description = "Retrouvez tous les guides du jeu " . $game['title'] . " référencés sur " . ucfirst($host); ?>
...
<div class="mt-3">
    ...
    <h1 class="text-center text-md-start fs-2 mb-3">Guides - <?= $game['title']; ?></h1>

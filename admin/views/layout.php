...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/<?= $tinyMCEKeys; ?>/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
</head>
<body id="page-top" class="sidebar-toggled">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
            ...
            <!-- Nav Item - Documentation Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseDocumentation"
                    aria-expanded="true" aria-controls="collapseDocumentation">
                    <i class="fas fa-book"></i>
                    <span>Documentation</span>
                </a>
                <div id="collapseDocumentation" class="collapse" aria-labelledby="headingDocumentation" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header"><i class="fas fa-cog"></i> Components</h6>
                        <a class="collapse-item" href="/administration/documentation/components/buttons">Buttons</a>
                        <a class="collapse-item" href="/administration/documentation/components/cards">Cards</a>
                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header"><i class="fas fa-wrench"></i> Utilities</h6>
                        <a class="collapse-item" href="/administration/documentation/utilities/animations">Animations</a>
                        <a class="collapse-item" href="/administration/documentation/utilities/borders">Borders</a>
                        <a class="collapse-item" href="/administration/documentation/utilities/colors">Colors</a>
                        <a class="collapse-item" href="/administration/documentation/utilities/others">Others</a>
                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header"><i class="fas fa-book"></i> Libraries</h6>
                        <a class="collapse-item" href="/administration/documentation/libraries/chart">Chart.js</a>
                        <a class="collapse-item" href="/administration/documentation/libraries/datatables">DataTables</a>
                    </div>
                </div>
            </li>
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="/public/img/undraw_profile.svg" alt="...">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="/administration/deconnexion/">Déconnexion</a>
                </div>
            </div>
        </div>
    </div>
